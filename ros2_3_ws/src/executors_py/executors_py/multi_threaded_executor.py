...
from rclpy.callback_groups import ReentrantCallbackGroup # Callbacks are called in paralell, even with themselves
from rclpy.callback_groups import MutuallyExclusiveCallbackGroup # Callbacks are called in paralell, but not with themselves
import time
